...
# Ao executarmos o primeiro exemplo podemos perceber que não é obrigatório usar parênteses para chamar o método,
# e nem return para retornar um valor, como é necessário em outras linguagens.
